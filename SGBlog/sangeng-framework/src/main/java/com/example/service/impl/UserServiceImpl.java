...
//// 立即从数据库中获取插入后的用户 ID
//        User savedUser = getOne(Wrappers.<User>lambdaQuery().eq(User::getUserName, user.getUserName()));
//
//// 传入已获取 ID 的 user 对象（替换原来可能没有 id 的 user）
